...
public class MainWindow {
	...
	private JPanel titlePanel,onOffButtonPanel,mainPanel,blankPanel,viewGardenPanel,programInputPanel,viewStatusPanel,zoneSelectionPanel,programSprinklerPanel,checkWaterConsumptionPanel;
	private JTabbedPane tabbedPane;
	JPanel submitButtonPanel,timeConfigPanel,temperatureConfigPanel,waterConfigPanel,statusZonePanel,statusDisplayPanel;
	...
	JLabel durationLabel,waterFlowLabel,maxTempLabel,minTempLabel,stopTimeLabel,startTimeLabel,zoneLabel,dayLabel;
	GardenController gardenController;
	JComboBox timeComboBox,zoneComboBox,sprinklerComboBox,dayComboBox,statusZoneComboBox;
	...
	private void initialize() {
		...
		frame.setLocation(size.width / 3 - frame.getWidth() / 3, size.height / 3
				- frame.getHeight() / 3);
	...
	public void createZoneSelectionPanel()
	{
		...
		//zoneComboBox.setModel(new DefaultComboBoxModel(gardenController.getGarden().getZoneNames()));
...
//		zoneSelectionPanel.add(sprinklerSelectionComboBox);
	...
	public void createTimeConfigPanel()
	{
		...
		//timeComboBox.setModel(new DefaultComboBoxModel(new String[] {"Week", "Day"}));
